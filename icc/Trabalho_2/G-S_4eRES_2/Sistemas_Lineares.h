...
/**
 * Calcula os valores de contornos e os coloca em x
 * 
 * @param	x	Vetor solução do Gauss Seildel (Inicializado com zeros)
 * @param	nx	Valor de nx passado na chamada do programa
 * @param	ny	Valor de ny passado na chamada do programa
 * 
 * @return	Vetor x com os valores de contornos
 */
